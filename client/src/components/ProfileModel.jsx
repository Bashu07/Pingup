                    ...
                    <form className='space-y-4' onSubmit={e=>toast.promise(
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="profile-picture" className='block text-sm font-medium text-gray-700 mb-1'>
                                Profile Picture
                                <input hidden type="file" accept='image/*' id='profile-picture' 
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="cover-photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <input hidden type="file" accept='image/*' id='cover-photo' 
                                 className='w-full p-3 border border-gray-200 rounded-lg'
                                  ...
                                  <div className='group/cover relative'>
                                    ...
                                    <div className='absolute hidden group-hover/cover:flex top-0 right-0 bottom-0 left-0 bg-black/20 rounded-lg items-center justify-center'>
                        ...
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your fullName' onChange={(e)=>setEditForm({...editForm, full_name:e.target.value})} value={editForm.full_name} />
                        </div>
